...
print(f"[+] Starting the connection : {connection_string}")
...
connection.execute(text(""" CREATE TABLE IF NOT EXISTS publishers  (
...
connection.execute(text("""  -- publishers
...
publishers = pd.read_sql("Select * from publishers;", connection)
print(f"Publishers table: \n{publishers}\n")

authors = pd.read_sql("Select * from authors;", connection)
print(f"Authors table: \n{authors}\n")

books = pd.read_sql("Select * from books;", connection)
print(f"Books table: \n{books}\n")

book_authors = pd.read_sql("Select * from book_authors;", connection)
print(f"Book Authors table: \n{book_authors}\n")
